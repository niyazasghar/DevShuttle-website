import { ArrowRight, Pill, ShieldCheck, Clipboard, Search, CreditCard, Lock, Zap, Server, Layout } from "lucide-react";
import Link from "next/link";

const keyFeatures = [
  {
    title: "Prescription Logic",
    icon: Clipboard,
    description: "Secure, intuitive upload and verification system for digital prescriptions with pharmacist validation workflows.",
  },
  {
    title: "HIPAA Compliant",
    icon: Lock,
    description: "Built with security-first architecture ensuring patient data privacy and regulatory compliance at every level.",
  },
  {
    title: "Pharmacist Portal",
    icon: Layout,
    description: "Comprehensive dashboard for licensed chemists to manage stock, verify orders, and communicate with patients.",
  },
  {
    title: "Inventory Sync",
    icon: Search,
    description: "Real-time medicine availability tracking across multiple branches and warehouse networks for instant fulfillment.",
  },
];
      ...
      <section className="container-wide mb-32 lg:mb-56">
        <div className="max-w-4xl">
          ...
          <p className="text-xl md:text-3xl text-brand-gray-400 font-light leading-relaxed text-balance">
            A secure, regulated software foundation for digital pharmacies and medicine delivery networks. Built for high trust and zero failure.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start mb-24 lg:mb-32 gap-16">
             <div className="max-w-xl">
                <h2 className="text-section-title text-brand-gray-900 leading-none mb-10">
                   Regulated software foundations.
                </h2>
                <p className="text-lg text-brand-gray-500 font-light leading-relaxed">
                   Launch your health-tech platform with a technical architecture that prioritizes security and reliability above all else. Fully customizable for various regional regulations.
                </p>
             </div>
             
             <div className="lg:w-1/3 flex flex-col gap-8 pt-12 border-t border-brand-gray-200">
                <span className="text-[10px] uppercase tracking-[0.3em] font-bold text-accent">Compliance Depth</span>
                <ul className="grid grid-cols-1 gap-4">
                   {["Prescription Upload API", "Identity Verification", "Stock Management", "Real-time Order Status", "Audit Logs", "Pharmacist Verification Workflow"].map(t => (
      ...
      <section className="py-32 lg:py-64 bg-background-dark border-t border-white/5 relative z-10 overflow-hidden text-center">
         <div className="container-wide flex flex-col items-center">
            <h2 className="text-section-title text-white mb-16 max-w-4xl !leading-tight">
               Build your health network <br />
               with <span className="text-accent underline underline-offset-8">Trust</span>.
            </h2>
            
            <p className="text-xl text-brand-gray-500 font-light max-w-2xl mb-24 leading-relaxed">
               Secure the technical base of your pharmacy platform with our pre-vetted foundation scripts. We guide you through the customization and security deployment.
            </p>
